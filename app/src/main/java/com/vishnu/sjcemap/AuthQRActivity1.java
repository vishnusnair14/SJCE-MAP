...
public class AuthQRActivity1 extends AppCompatActivity {
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivity = new Intent(AuthQRActivity1.this, MainActivity.class);
        authQRActivity = new Intent(AuthQRActivity1.this, AuthQRActivity1.class);
...
//                        stopLocationService();
    ...
    private void checkPermission() {
        ...
        if (!isFineLocationGranted || !isCoarseLocationGranted) {
            showProminentDisclosure("Turn on your location",
                    "To authenticate user, allow SJCE MAP to access your location", "loc");
        } else {
        ...
        if (!isCameraGranted) {
            showProminentDisclosure("Turn on your camera",
                    "To scan QR code , allow SJCE MAP to access your camera", "cam");
        } else {
            showEnableLocationBtmView(false);
        }

        if (isFineLocationGranted && isCoarseLocationGranted && isCameraGranted) {
            init();
        }
    }
    ...
    private void registerPermissionListener() {
        ...
        locationPermissionRequest = registerForActivityResult(new ActivityResultContracts
                    ...
                    if (Boolean.TRUE.equals(coarseLocationGranted) && Boolean.TRUE.equals(fineLocationGranted)) {
                        if (isLocationNotEnabled(this)) {
                            showEnableLocationBtmView(true);
                        } else {
                            Log.d(LOG_TAG, "else patr not ");
                        }
                    }
                }
        );
    ...
    private void showProminentDisclosure(String title, String message, String type) {
        ...
        if (type.equals("cam")) {
            ...
            subHeadingTxt1.setText(message);
...
//                    gpsCheckBtmDialog.dismiss();
                    ...
                    // GPS coordinates are not valid, check again after the interval
                    setStatusMsgView(R.string.loading, true);
...
//        }
    ...
    private void initialiseScanDetectorsAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(@NonNull SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(AuthQRActivity1.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
            ...
            public void receiveDetections(@NonNull Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() != 0) {
                    ...
                    if (scannedData.trim().equals(AUTH_ACCESS_KEY)) {
                        if (isLocationNotEnabled(AuthQRActivity1.this)) {
    ...
    private void showEnableLocationBtmView(boolean _show) {
        if (_show) {
            ...
            Button enableLocationBtn = enableLocationBottomView.findViewById(R.id.goToSettings_button);
            ...
            public void run() {
                ...
                if (remainingTime > 0) {
                    ...
                    if (!isIntentPassedToMain) {
                        Toast.makeText(AuthQRActivity1.this,
